                ...
                <tr>
                    <td>
                        <span class="custom-checkbox">
                            <input type="checkbox" id="checkbox{{ $book->id }}" name="options[]" value="{{ $book->id }}">
                    ...
                    <td>
                        <!-- Xem chi tiết sách -->
                        <a href="{{ route('books.show', $book->id) }}" class="view">
                            <i class="material-icons" data-toggle="tooltip" title="View">&#xE8F4;</i>
                        </a>
                        <!-- Xóa sách -->
                        <a href="#deleteBookModal" class="delete" data-toggle="modal" data-id="{{ $book->id }}">
